...
{
    public NowCallModel(DateTime callStartTime, int callId, DateTime callEndTime, string souguuReason, int user1, string user1Token, int user2, string user2Token, string cancellationReason, DateTime souguuDateTime)
    {
